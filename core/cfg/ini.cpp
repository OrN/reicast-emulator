...
float ConfigFile::get_float(string section_name, string entry_name, float default_value)
{
	ConfigEntry* entry = this->get_entry(section_name, entry_name);
	if (entry == NULL)
	{
...
void ConfigFile::set_float(string section_name, string entry_name, float value, bool is_virtual)
{
	std::stringstream str_value;
	str_value << value;
	this->set(section_name, entry_name, str_value.str(), is_virtual);
